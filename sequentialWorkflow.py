...
def editer_node(state:pipelinestate)->dict:
 ...
 prompt=(
  "You are an exper copyeditor.Clean up the following raw text."
  "Fix any grammatical errors,spelling mistakes and smoooth out the transition flow."
...
def translator_node(state:pipelinestate)->dict:
 ...
 prompt=(
  ...
  "or repeat information. Alternating comfortably between Hindi and English like "
...
#and for creating the graph you have to connect test nodes and for that you have to use the edges
...
graph.add_node("editor",editer_node)
...
app=graph.compile()
result=app.invoke({
 "raw_input":"AI agents are the future of tech.They canthink,plan,and act on their own.Langgraph helps you build these agents with proper control and memory."
})
#output
print("Your result:- \n\n")
