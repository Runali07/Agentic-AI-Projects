...
WRITER_SYSTEM_PROMPT=(
 ...
 "150-200 words, ends with a question or call-to-action to invalid "
...
REVIEWER_SYSTEM_PROMPT=(
 ...
 "2.One clear,valuable takeway\n"
 "3.Easy to skim-uses short paragraphs\n"
 "4.Roughly 150-200 words\n"
 "5.Ends with an engaging question or CTA\n"
 "6.Professional but human tone(not coporate-robotic)\n"
 "7.No hashtags\n\n"
...
def should_use_tool(state:State):
 last_messagee=state['messages'][-1]
 if getattr(last_messagee,'tool_calls',None):
  return "tools"
...
print("="*55)
topic=input("\nWhat topic do ypu want a LinkedIn post about?\n").strip()
if not topic:
